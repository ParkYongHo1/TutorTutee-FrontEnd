  ...
  return (
    <>
      <div className="relative h-[450px]">
        <div className="w-[500px] h-[15px] bg-gray-400 border-[2px] rounded-[20px] mb-[20px] shadow-inner "></div>
        <div
      ...
      <Link
        to="/"
        className="cursor-pointer bg-white text-black border-[2px] h-[60px] text-lg w-full font-bold text-center flex items-center justify-center"
      >
        메인으로
      </Link>
    </>
